...
#taxaLevelList <- c("Family")
taxaLevelList <- c("Genus", "Family", "Order", "Class", "Phylum")
...
for (i in 1:length(taxaLevelList)) {
  ...
  ## check sample order
  print(table(colnames(data)[2:ncol(data)] == aliquotInfo$Aliquot_barcode))
  ...
  svg(filename=paste("Shannon_index_PT_", taxaLevel, ".svg", sep=""), 
      width=6, height=5)
  plot <- ggplot(aliquotInfo_diversity_PT, 
  ...
  svg(filename=paste("Shannon_index_STNvsPT_N10_", taxaLevel, ".svg", sep=""),
      width=15, height=9)
  plot <- grid.arrange(grobs=plot_list,ncol=5)
  print(plot)
  dev.off()
  ...
  svg(filename=paste("Simpson_index_Diversity_STNvsPT_N10_", taxaLevel, ".svg", sep=""),
      width=15, height=9)
  plot <- grid.arrange(grobs=plot_list,ncol=5)
  print(plot)
  dev.off()
  ...
  svg(filename=paste("Simpson_Reciprocal_index_STNvsPT_N10_", taxaLevel, ".svg", sep=""),
      width=15, height=9)
  plot <- grid.arrange(grobs=plot_list,ncol=5)
  print(plot)
  dev.off()
  ...
  svg(filename=paste("Richness_STNvsPT_N10_", taxaLevel, ".svg", sep=""),
      width=15, height=9)
  plot <- grid.arrange(grobs=plot_list,ncol=5)
  print(plot)
  dev.off()
  ...
  svg(filename=paste("Evenness_STNvsPT_N10_", taxaLevel, ".svg", sep=""),
      width=15, height=9)
  plot <- grid.arrange(grobs=plot_list,ncol=5)
  print(plot)
  dev.off()
  ...
  svg(filename=paste("Shannon_index_STNvsPT_N10_merge_", taxaLevel, ".svg", sep=""),
      width=12, height=8)
  plot <- ggplot(aliquotInfo_diversity_PTandSTN,
  ...
  svg(filename=paste("Simpson_index_Diversity_STNvsPT_N10_merge_", taxaLevel, ".svg", sep=""),
      width=12, height=8)
  plot <- ggplot(aliquotInfo_diversity_PTandSTN,
  ...
  svg(filename=paste("Simpson_Reciprocal_index_STNvsPT_N10_merge_", taxaLevel, ".svg", sep=""),
      width=12, height=8)
  plot <- ggplot(aliquotInfo_diversity_PTandSTN,
  ...
  svg(filename=paste("Richness_STNvsPT_N10_merge_", taxaLevel, ".svg", sep=""),
      width=12, height=8)
  plot <- ggplot(aliquotInfo_diversity_PTandSTN,
  ...
  svg(filename=paste("Evenness_STNvsPT_N10_merge_", taxaLevel, ".svg", sep=""),
      width=12, height=8)
  plot <- ggplot(aliquotInfo_diversity_PTandSTN,
